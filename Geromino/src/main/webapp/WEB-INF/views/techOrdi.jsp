...
<tiles:insertDefinition name="app.layout">
	...
	<tiles:putAttribute name="content">
		...
		<table class="table table-striped" style="text-align: center">
			...
			<c:forEach items="${ ordinateurs }" var="ordinateur">
				...
				<tr>
					...
					<td><a href="/Geromino/technicien/ordi/etat?id=${ordinateur.id}"
						class="btn btn-warning">Réparation</a> </td>
		...
		<a href="/Geromino/technicien/ordi/ajouter" class="btn btn-success">Ajouter
			un ordinateur</a>
		<a href="/Geromino/technicien">
			<button type="button" class="btn btn-danger">Revenir au menu
				précédent</button>
		</a>
