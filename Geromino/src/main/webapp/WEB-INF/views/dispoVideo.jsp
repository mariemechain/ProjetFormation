...
<tiles:insertDefinition name="app.layout">
	...
	<tiles:putAttribute name="title"
		value="Définir la disponibilité du vidéoprojecteur" />
		...
		<form:form method="POST" modelAttribute="videoprojecteur">
			<div class="container">
				...
				<div class="form-group">
					<label for="id">Identifiant :</label> <label>${videoprojecteur.id}</label>
				</div>

				<div class="form-group">
					<label for="date">Veuillez indiquer la date de retour de réparation estimé du matériel :</label> <input name="date"
