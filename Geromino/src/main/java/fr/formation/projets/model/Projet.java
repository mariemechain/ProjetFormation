...
//	@OneToOne
//	@JoinColumn(name="PRO_GESTIONNAIRE") private Gestionnaire gestionnaire;
	
	@Temporal(TemporalType.DATE)
	@Column(name="PRO_DEBUT") private Date debut; 
...
//	@JoinTable(
//		name="reservation", 
//		joinColumns = @JoinColumn(name="RES_PROJET_ID", referencedColumnName="PRO_"),
//		inverseJoinColumns = @JoinColumn(name="RES_STAGIAIRE_ID", referencedColumnName="STA_ID")
